 ...
 * list with sorted values and a single skip layer with nodes at every idx
 * which is a multiple of the square root of the size of the list
 *
 * @list: ptr to the head of the skip list to traverse
 * @value: value to search for
 * Return: ptr on the first node where value is located, or NULL if list
